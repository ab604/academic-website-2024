...
## Raspberry Pi based music streamer

I documented replacing my old Sonos Connect in my Hi-Fi set-up with a Raspberry Pi running Mopidy Music Server and an external DAC on [my blog](https://ab604.uk/blog/2025-04-17-mopidy/)

## Work in progress bot {#sec-work-in-progress-bot}

![](images/fluent-emoji-high-contrast--man.png){width="100"}

Another **retired** Bluesky bot. Work in Progress is now on Bluesky so I took this down.
...
A **retired** Bluesky bot. Our World in Data is now on Bluesky so I took this down.

The bot that posted a screen shot of the Our World in Data (OWID) Daily Data Insight to Bluesky.
